    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center mt-4">
                <a href="{{ Route('index') }}" class="btn btn-dark">Homepage</a>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-4 d-flex justify-content-center">
                                <img src="{{ Vite::asset('resources/img/') }}{{ $comic->cover_image }}" alt="banner-image" class="border border-black border-5">
                            </div>
                            <!-- Details -->
